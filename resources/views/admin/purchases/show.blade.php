...
@section('content')
    ...
    <div class="box bg-white">
        <table class="table" aria-hidden="true">
            ...
            <tr>
                <td class="border-0" style="width:20%">Purchase Date</td>
                <td class="border-0" style="width:5%">:</td>
                <td class="border-0" style="width:25%">
                    {{ !empty($entry->purchase_date) ? Carbon::parse($entry->purchase_date)->format('d-m-Y') : '' }}</td>
                <td class="border-0" style="width:20%">Discount Type</td>
                <td class="border-0" style="width:5%">:</td>
                <td class="border-0" style="width:25%">
                    @if ($entry->discount_type == 'per_item')
                        Per Item
                    @endif
                    @if ($entry->discount_type == 'per_invoice')
                        Per Invoice
                    @endif
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="border-0" style="width:5%">:</td>
                <td class="border-0" style="width:25%">{{ $entry->purchase_note }}</td>
            </tr>
    ...
    <div class="card-header bg-white"><strong>Purchase Detial</strong></div>
    <div class="box bg-white">
