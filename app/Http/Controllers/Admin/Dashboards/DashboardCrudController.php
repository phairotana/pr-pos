...
class DashboardCrudController extends CrudController
{
    ...
    public function index()
    {
        ...
        $data['sales_dash'] = Helper::calculatNumberToK(DashboardLib::salesDash());
        $data['sales_return_dash'] = Helper::calculatNumberToK(DashboardLib::salesReturnDash());
        $data['purchases_dash'] = Helper::calculatNumberToK(DashboardLib::purchasesDash());
        ...
        $data['monthly_expense'] = DashboardLib::monthlyExpense();
        $data['monthly_payment'] = DashboardLib::monthlyPayment();
