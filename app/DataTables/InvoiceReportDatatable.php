...
class InvoiceReportDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('invoice_date', function ($query) {
                return $query->InvoiceDateFormat;
            })
    ...
    public function query(Invoice $model)
    {
        ...
        if (!empty($this->startDate)) {
            $query->whereDate('invoice_date', '>=', Carbon::parse($this->startDate)->format('Y-m-d'));
        }
        if (!empty($this->endDate)) {
            $query->whereDate('invoice_date', '<=', Carbon::parse($this->endDate)->format('Y-m-d'));
        }
