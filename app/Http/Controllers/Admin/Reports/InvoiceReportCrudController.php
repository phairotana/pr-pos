 ...
 */
class InvoiceReportCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . 'report/invoice');
        CRUD::setEntityNameStrings('report/invoice', 'invoice report');
    }
    ...
    protected function index()
    {
        ...
        $view = 'reports.invoiceReport';
        if (request()->ajax()) {
            $dataTable = new InvoiceReportDatatable(request()->startDate, request()->endDate, request()->branch);
