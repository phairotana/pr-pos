...
@section('content')
    <div id="mySidenav" class="sidenav shadow right col-md-4">
        ...
        <div class="form-group col-12 col-sm-6 col-md-12">
            <label for="select2_branch"> Branch </label>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap overflow-auto mt-3" style="width:100%">
                            <thead>
                                <tr>
                                    <th scope=""> No</th>
                                    <th scope="">Customer Code</th>
                                    <th scope="">Customer Name</th>
                                    <th scope="">Phone</th>
                                    <th scope="">Branch</th>
                                    <th scope="">Total Bought</th>
                                    <th scope="">Amount</th>
                                    <th scope="">Paid</th>
                                    <th scope="">Due</th>
                                    <th scope="">Action</th>
            ...
            $('#datatable-filters').find('table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'id',
                        render: function(data, type, row, meta) {
                            return '<a class="btn btn-info btn-sm" href="/admin/customers/' + row.id +
                                '/show" target="_blank" title="Detail">' +
