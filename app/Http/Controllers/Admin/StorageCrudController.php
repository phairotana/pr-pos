...
class StorageCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        RolePermission::checkPermission($this->crud, 'item location');
        CRUD::setModel(\App\Models\Storage::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/storage');
        CRUD::setEntityNameStrings('storage', 'storages');
        if (request()->trashed) {
    ...
    {
        CRUD::setValidation(StorageRequest::class);
