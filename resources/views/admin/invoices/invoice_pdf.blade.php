...
<head>
    <title>MR HANG::PRINT INVOICE</title>
...
<body>
    ...
    <div>
        <h2 style="font-family: kh_moul, sans-serif; text-align:center;">
            វិក័យបត្រ / <strong>INVOICE</strong>
        </h2>
        ...
        <div class="row">
            <div style="float: right; width: 49%;">
                <table class="table table-border font-battambang" aria-hidden="true">
                    <tr>
                        <td class="khbattambang" style="width: 35%;">លេខវិក័យបត្រ</td>
                        <td class="khbattambang" style="word-break: break-all; width: 35px;">
                            {{ $entry->code }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="khbattambang">លេខបញ្ជាទិញ</td>
                        <td class="khbattambang" style="word-break: break-all;">
                            ...................................................</td>
                    </tr>
                </table>
            ...
            <div class="col-lg-6 head-left" style="float: left; width: 49%;">
                <table class="table table-border" aria-hidden="true" style="word-break: break-all;">
                    <tr style="word-break: break-all;">
                        <td class="khbattambang" style="width: 35%; word-break: break-all;">ក្រុមហ៊ុន</td>
                        <td class="khbattambang" style="word-break: break-all;">
                            {{ optional($entry->customer)->company }}
                        </td>
                    </tr>
                    <tr style="word-break: break-all;">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6" style="float: right; width: 49%;">
                        <table class="table table-border">
                            ...
                            <tr>
                                <td class="khbattambang">កក់មុន</td>
                                <td style="background: aliceblue;"><strong>
                                        {{ \Str::numberFormatDollar($entry->received_amount, 3) }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="khbattambang">នៅខ្វះ</td>
